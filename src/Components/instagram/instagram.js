...
import Yt from "../../images/insta.png";
  ...
  return (
    <div className="youtube">
      ...
      <div className="text-bet">
        <h1 className="yt_text">Instagram Video Downloader</h1>
        <img src={Line} alt="Decorative line" />
        <h5 className="desc">Try this unique tool for quick, hassle-free downloads from Instagram. Transform your offline video collection with this reliable and efficient downloader.</h5>
      </div>
